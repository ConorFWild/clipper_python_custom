...
//        .def_property_readonly("hkl_sampling", &CCP4MAPfile::hkl_sampling)
        ...
        .def("import_xmap", [](CCP4MAPfile& self, Xmap<float>& xmap) { self.import_xmap(xmap); })
	.def("import_xmap_float", [](CCP4MAPfile& self, Xmap<float>& xmap) { self.import_xmap(xmap); })   
	.def("import_xmap_double", [](CCP4MAPfile& self, Xmap<double>& xmap) { self.import_xmap(xmap); })
